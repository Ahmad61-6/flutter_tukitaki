                ...
                child: Obx(()=>
                    Column(
                      ...
                      children: [
                        ...
                        ,SizedBox(height: 20.h,),
                        AuthField(hintText: 'Password',controller: passwordTEController,validator: AppValidator.validatePassword,obscureText: signupController.obscureText1.value,suffixIcon: signupController.obscureText1.value ? Icon(Icons.visibility) : Icon(Icons.visibility_off),onTap:()=> signupController.changeVisibility(1),),
                        SizedBox(height: 20.h,),
                        AuthField(hintText: 'Confirm Password',controller: confirmPasswordTEController,validator: AppValidator.validatePassword,obscureText:signupController.obscureText2.value,suffixIcon:signupController.obscureText2.value ? Icon(Icons.visibility) : Icon(Icons.visibility_off),onTap:()=> signupController.changeVisibility(2),)
                        ,SizedBox(height: 20.h,),
                        AuthGradientButton(text: 'Signup'),
